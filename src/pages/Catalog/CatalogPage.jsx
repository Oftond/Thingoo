...
const CatalogPage = () => {
  ...
  return (
    <div className={`catalog-page ${isDarkMode ? 'dark' : 'light'}`} onClick={closeAllDropdowns}>
      {/* Хедер */}
        ...
        <div className="container">
          <div className="header-content">
            ...
            <div className="search-bar">
              ...
              <input
                type="text"
                placeholder="Что ищете? Например, велосипед или проектор"
                value={searchQuery}
            ...
            <div className="header-actions">
              ...
              <button className="btn btn-primary" onClick={goToCreateListing}>
      ...
      <main className="main-content">
        <div className="container">
          ...
          {/* Основной контент с фильтрами и карточками */}
          ...
          <div className="footer-content">
            <div className="footer-section">
              ...
              <p className="footer-description">
                Сервис аренды вещей. Арендуйте то, что нужно, и делитесь тем, что есть.
              </p>
            ...
            <div className="footer-section">
              ...
              <ul className="footer-links">
                <li><a href="/">Для арендаторов</a></li>
                <li><a href="/">Для арендодателей</a></li>
                <li><a href="/">Процесс аренды</a></li>
