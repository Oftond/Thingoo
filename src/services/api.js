...
export const usersAPI = {
  ...
  update: async (id, data) => {
    console.warn('PUT /users/{id} not implemented on backend');
    return { data: { ...data, id } };
  },
  delete: async (id) => {
    console.warn('DELETE /users/{id} not implemented on backend');
    return { data: { success: true } };
  },
};
...
export const authAPI = {
  ...
  register: (userData) => {
    const backendData = {
      ...
      city: userData.city,
      passport_series: userData.passportData.series,
      passport_number: userData.passportData.number,
      passport_issued_by: userData.passportData.issuedBy,
      passport_issue_date: userData.passportData.issuedDate
    };
